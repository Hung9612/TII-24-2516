/*
% TorqueCompute_planar_2_link.c 
*/
#include "mex.h"
#include <math.h>
#include "TorqueCompute_planar_2_link_lib.h"
                  ...
                  int nrhs, const mxArray *prhs[])
{
	...
	TorqueCompute_planar_2_link_lib(Q, Qd, Qdd, Theta, N, tau);
}