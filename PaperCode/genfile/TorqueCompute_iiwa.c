/*
% TorqueCompute_iiwa.c 
*/
#include "mex.h"
#include <math.h>
#include "TorqueCompute_iiwa_lib.h"
                  ...
                  int nrhs, const mxArray *prhs[])
{
	...
	TorqueCompute_iiwa_lib(Q, Qd, Qdd, Theta, N, tau);
}