/*
% TorqueCompute_DOF3_Ctrl_lib.c comput torque
*/

#include <math.h>

void TorqueCompute_DOF3_Ctrl_lib(const double *Q, const double *Qd, const double *Qdd, const double *Theta, int N, double *tau)
{
	int pos;
	char k;
	int startInd;
